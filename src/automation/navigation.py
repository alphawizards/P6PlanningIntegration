...
class P6Navigator:
    ...
    SHORTCUTS = {
        ...
        'help': '{F1}',         # F1
        'close': '^{F4}',       # Ctrl+F4 (close current)
        'close_w': '^W',        # Ctrl+W (close current, alternative)
        'exit': '%{F4}',        # Alt+F4
    }
    ...
    def get_current_view(self) -> str:
        ...
        Strategy: Check tab control for selected tab, then fall back
        to window title parsing.
