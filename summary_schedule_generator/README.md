...
├── docs/                        # Documentation
│   └── README_generate_summary_schedule.md  # Detailed technical documentation
├── scripts/                     # Python scripts
│   └── generate_summary_schedule.py         # Main generator script
├── templates/                   # Template XER files
│   └── 19282-FS-Summary-FS-EXE.xer         # P6 project template
├── input/                       # Input data files
│   └── WBS Summary.xlsx         # Excel file with summary WBS data
└── output/                      # Generated output files
    └── 19282_Summary_Schedule_Generated.xer  # Generated summary schedule
...
- Duration: `(Finish - Start) × 8 hours/day`

### Status Assignment
- `TK_Active` (In Progress): Start date ≤ today
