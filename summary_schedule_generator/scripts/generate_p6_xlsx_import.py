...
class P6XLSXGenerator:
    ...
    def __init__(
        ...
        self.output_filename: str = f"{project_name}_Import_{date_stamp}.xlsx"
    ...
    def _load_source_data(self) -> pd.DataFrame:
        ...
        Returns:
            Cleaned DataFrame with activity codes and parsed dates.

        Raises:
            KeyError: If required columns ('WBS', 'Start', 'Finish') are
        ...
        required_columns = ['WBS', 'Start', 'Finish']
    ...
    def _copy_template(self) -> None:
        """Create a copy of the template file to the output path."""
    ...
    def _populate_task_sheet(self, df: pd.DataFrame) -> None:
        ...
        Args:
            df: Cleaned source DataFrame with activity codes and dates.
        """
    ...
    def _delete_reference_row(self) -> None:
